        ...
        <v-form v-model="valid" lazy-validation>
          <div class="grey lighten-3 rounded-xl col-md-5 mx-auto my-auto">
            ...
            <h2 class="text-center">
              PESERTA Tempat Uji Kompetensi(TUK)
              <br />
            ...
            <div class="jumbotron mt-4">
              ...
              <div>
                <div class="row align-center justify-center">
                  <v-btn :disabled="!valid" class="white--text" color="#065139" @click="login">login</v-btn>
                </div>
                <div class="row align-center justify-center">
                  <v-btn text color="#065139" @click="daftar">daftar</v-btn>
                </div>
              </div>
            </div>
          </div>
  ...
  methods: {
    ...
    daftar: function () {
      (this.id = this.$route.params.id),
        this.$router.push({ name: "daftar-akun", params: { id: this.id } });
    },
  },
  mounted() {
